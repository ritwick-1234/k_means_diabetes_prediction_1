...
# Sidebar - Collect user inputs for hyperparameters
...
# Define function to map predicted labels to true labels
...
# Features selection (exclude the target column 'Outcome')
...
if st.sidebar.button('Submit'):
    ...
    # Mapping predicted labels to true labels for training and test sets
